...
`unit_backlog.yaml` 의 단원 구조를 보고 배분한다. **기준은 총량이 아니라 소주제당 3~5개다.**
소주제 6개면 20~30, 8개면 26~40 이 자연스럽다. 상한 40 을 목표로 삼지 마라 —
소주제 3개짜리 단원이 40개면 잘게 쪼갠 것이다. 10에 못 미치면 뭉뚱그린 것이다.

(2026-09-08 교사 결정으로 상한을 30 에서 40 으로 올렸다. 30 은 소주제 6개짜리
단원 기준이라 소주제 7~8개 단원에서 성취기준 표제 문구조차 카드를 못 받았다.)
